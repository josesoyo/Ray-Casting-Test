...
let all = {Meshes = [];
           Sphere = []; PartSphere=[]; SurfaceLens =[]
           Cylinder =[cyl]} //for sphere
...
let origin = Point3D(-pixsize,-0.0,-0.750) // for sensor
//
...
let phgr = Chart.Line(pharr, Name= "Logintensity a 1m Cila rad5 pic").ShowChart()
gr.ShowChart()
