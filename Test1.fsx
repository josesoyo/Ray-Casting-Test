...
let mesh3 = ReadMeshWavefront(path3,reflective)|> fun x -> Translate x (Vector3D(-2.00,-2.0,0.0))|> Mesh_BBox 
//printfn "%+A" mesh1.Vertices
let all = {Meshes = [mesh1;mesh2;mesh3];Sphere = []}
let Scene = {Camera=camera ;World = all; Light=[light;light2;light1]} 
...
bmp.Save(@"C:\Users\JoseM\Desktop\img_render\test_meshes_bbox2.jpg")
