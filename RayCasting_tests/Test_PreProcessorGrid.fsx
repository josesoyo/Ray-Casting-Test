...
#r @"packages\MathNet.Numerics.Signed.3.8.0\lib\net40\MathNet.Numerics.dll"
#r @"packages\MathNet.Numerics.FSharp.Signed.3.8.0\lib\net40\MathNet.Numerics.FSharp.dll"
...
//gourd.obj"/
//difus_human
let mesh1= ReadMeshWavefront(path,whitte)|> fun x -> Translate x (Vector3D(0.0,0.0,-0.10)) |> Mesh_BBox//|> fun x -> Scale x [0.25;0.25;0.25]|> fun x -> Translate x (Vector3D(3.50,1.0,-2.0))|> Mesh_BBox 
let mesh2 = ReadMeshWavefront(path2,whitte) |> Mesh_BBox 
//printfn "%+A" mesh1.Vertices
let all = {Meshes = [mesh1];Sphere = [ ]} // mesh2; -  ball;ball2
